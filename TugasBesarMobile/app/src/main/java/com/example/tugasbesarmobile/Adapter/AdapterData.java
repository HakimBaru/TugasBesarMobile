package com.example.tugasbesarmobile.Adapter;
...
import com.example.tugasbesarmobile.Activity.MainActivity;
import com.example.tugasbesarmobile.Activity.UbahActivity;
...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData> {
    ...
    public void onBindViewHolder(@NonNull HolderData holder, int position) {
        DataModel dm = filteredList.get(position); // Ubah listData menjadi filteredList
